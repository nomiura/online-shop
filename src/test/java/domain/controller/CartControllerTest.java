...
class CartControllerTest {
    ...
    //-------------------------------------------------------------------------
    @Test
    @DisplayName("GET /cart - Should return 200 OK and dto the existing cart")
    ...
    //-------------------------------------------------------------------------
    @Test
    @DisplayName("POST /cart/items - Should return 201 Created add item to cart and return CREATED 201")
